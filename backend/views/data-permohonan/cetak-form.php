...
$this->title = 'Cetak Rekap Laporan Ormas';
...
<body onload="window.print();">
            ...
            <div class="row">
                <div class="col-xs-12 text-center" style=" height: 80px;">
                    <table width="100%">
                        <tr>
                            <td width="82%">
                                <p style="font-size:20px;"><b>DATA LAPORAN PERMOHONAN ORMAS</b></p>
    ...
    <body>
        ...
        <head>
            <title>LAPORAN DATA PERMOHONAN ORMAS</title>
        </head>
        ...
        <body>
            ...
            <table width="745" border="1" cellspacing="0" cellpadding="5" align="center">
                <tr align="center" bgcolor="#66CC33">
                    <td width="174">DATA PERMOHONAN</td>
                    <td width="353"></td>
        ...
        <table width="100%" style="border:1px solid black;">
            <tr style="font-size:25px; font-family:times new roman;">
                <td width="25%" align="center" style="border:1px solid black;  padding:5px; padding-top: 2px; padding-bottom: 1px; ">Calon suami
                </td>
                <td width="25%" align="center" style="border:1px solid black; padding:5px; padding-top: 2px; padding-bottom: 1px; ">Calon istri
                </td>
            </tr>
            <tr style="font-size:25px; font-family:times new roman;">
            ...
            <tr style="font-size:25px; font-family:times new roman;">
                <td width="25%" align="center" style="border:1px solid black; padding:5px; padding-top: 2px; padding-bottom: 1px; ">
                    (.................................................) </td>
                <td width="25%" align="center" style="border:1px solid black;  padding:5px; padding-top: 2px; padding-bottom: 1px; ">
                    (.................................................) </td>
            </tr>
